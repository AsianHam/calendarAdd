...
def build():
    ...
    b2875Radio, lc9aRadio, lc9bRadio, lc9cRadio = Radiobutton(frame), Radiobutton(frame), Radiobutton(frame), Radiobutton(frame)
    lewisohn203aRadio, lewisohn203bRadio, lewisohn203dRadio = Radiobutton(frame), Radiobutton(frame), Radiobutton(frame)
    lewisohn203eRadio, lewisohn203fRadio, lewisohn203iRadio = Radiobutton(frame), Radiobutton(frame), Radiobutton(frame)
    lewisohn203k6Radio, lewisohn203k7Radio, lewisohn203nRadio = Radiobutton(frame), Radiobutton(frame), Radiobutton(frame)
    lewisohn203yRadio, lewisohn203zRadio, lewisohn214aRadio = Radiobutton(frame), Radiobutton(frame), Radiobutton(frame)
    lewisohn303aRadio,lewisohn303cRadio, lewisohn504aRadio = Radiobutton(frame), Radiobutton(frame), Radiobutton(frame)
    lewisohn504bRadio, lewisohn504cRadio = Radiobutton(frame), Radiobutton(frame)
    lewisohn504dRadio, lewisohn504fRadio = Radiobutton(frame), Radiobutton(frame)
